"""
Ansible ServiceType dataclass — user-facing stable interface.
...
@dataclass
class AnsibleServiceTypes(BaseTransformMixin):
    """Ansible representation of a gateway service_type (resource module pattern)."""
