...
class APIRoleUserAssignment_v1(BaseTransformMixin):
    """API v1 representation of a gateway role_user_assignment."""
...
class RoleUserAssignmentTransformMixin_v1(BaseTransformMixin):
    ...
    def from_ansible_data(
        ...
        # Resolve object_id: prefer explicit object_id, else derive from object_ids list
        obj_id = getattr(ansible_instance, "object_id", None)
        if obj_id is not None:
            api_data["object_id"] = obj_id
        else:
            object_ids = getattr(ansible_instance, "object_ids", None)
            if object_ids:
                api_data["object_id"] = str(object_ids[0])
    ...
    def get_endpoint_operations(cls) -> Dict[str, EndpointOperation]:
        return {
            "create": EndpointOperation(
                ...
                method="POST",
                fields=["object_id", "object_ansible_id", "role_definition", "user", "user_ansible_id"],
                required_for="create",
                order=1,
            ),
