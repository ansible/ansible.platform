    ...
    def get_endpoint_operations(cls) -> Dict[str, EndpointOperation]:
        ...
        return {
            "create": EndpointOperation(
                ...
                method="POST",
                # is_platform_auditor omitted: managed via role_user_assignment (see plugins/action/user.py)
            ...
            "update": EndpointOperation(
                ...
                # is_platform_auditor is omitted: it is a read-only computed field reflecting the
                # user's Platform Auditor role assignment.  The user action plugin manages it via
                # role_user_assignment CRUD instead (see plugins/action/user.py).
