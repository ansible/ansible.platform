    ...
    def get_endpoint_operations(cls) -> Dict[str, EndpointOperation]:
        return {
            ...
            "update": EndpointOperation(
                path="/api/gateway/v2/organizations/{id}/", method="PATCH", fields=["name", "description"], path_params=["id"], required_for="update", order=1
            ),
            "delete": EndpointOperation(
                path="/api/gateway/v2/organizations/{id}/", method="DELETE", fields=[], path_params=["id"], required_for="delete", order=1
            ),
