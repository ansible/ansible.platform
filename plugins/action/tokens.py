...
"""
Action plugin for ansible.platform.tokens resource module.
...
class ActionModule(BaseResourceActionPlugin):
    """Resource module action plugin for tokens."""

    USER_MODEL = "plugins.plugin_utils.ansible_models.tokens.AnsibleTokens"
