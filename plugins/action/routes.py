...
"""
Action plugin for ansible.platform.routes resource module.
...
class ActionModule(BaseResourceActionPlugin):
    """Resource module action plugin for routes."""

    USER_MODEL = "plugins.plugin_utils.ansible_models.routes.AnsibleRoutes"
