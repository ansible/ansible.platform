...
"""
Action plugin for ansible.platform.token resource module.
...
class ActionModule(BaseResourceActionPlugin):
    """Resource module action plugin for token."""

    USER_MODEL = "plugins.plugin_utils.ansible_models.token.AnsibleToken"
