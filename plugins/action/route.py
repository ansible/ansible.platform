...
"""
Action plugin for ansible.platform.route resource module.
...
class ActionModule(BaseResourceActionPlugin):
    """Resource module action plugin for route."""

    USER_MODEL = "plugins.plugin_utils.ansible_models.route.AnsibleRoute"
