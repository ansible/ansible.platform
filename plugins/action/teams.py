...
"""
Action plugin for ansible.platform.teams resource module.
...
class ActionModule(BaseResourceActionPlugin):
    """Resource module action plugin for teams."""

    USER_MODEL = "plugins.plugin_utils.ansible_models.teams.AnsibleTeams"
