...
"""
Action plugin for ansible.platform.service resource module.
...
class ActionModule(BaseResourceActionPlugin):
    """Resource module action plugin for service."""

    USER_MODEL = "plugins.plugin_utils.ansible_models.service.AnsibleService"
